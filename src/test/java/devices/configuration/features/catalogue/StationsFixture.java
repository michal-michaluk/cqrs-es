...
import static devices.configuration.features.catalogue.location.OpeningHours.OpeningTime.closed;
import static devices.configuration.features.catalogue.location.OpeningHours.OpeningTime.opened;

public class StationsFixture {

    public static Station evb() {
        return evb("EVB-" + UUID.randomUUID());
    }

    public static Station evb(String stationName) {
        return new Station()
                .setName(stationName)
    ...
    public static Station matchinEggplantStationsExport() {
    ...
    public static Station matchinPactExampleEFACECQC0032() {
        return new Station()
